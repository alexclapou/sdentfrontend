export default function Testimonial() {
  return (
    <div className="w-full bg-white border-t border-b border-gray-200 px-5 py-16 sm:py-24 text-gray-800">
      <div className="w-full max-w-6xl mx-auto">
        <div className="text-center max-w-xl mx-auto">
          <h1 className="text-6xl sm:text-7xl font-bold mb-5 text-gray-600">
          ...
          <div className="text-center mb-10">
            <span className="inline-block w-1 h-1 rounded-full bg-primary-color ml-1"></span>
            <span className="inline-block w-3 h-1 rounded-full bg-primary-color ml-1"></span>
            <span className="inline-block w-40 h-1 rounded-full bg-primary-color"></span>
            <span className="inline-block w-3 h-1 rounded-full bg-primary-color ml-1"></span>
            <span className="inline-block w-1 h-1 rounded-full bg-primary-color ml-1"></span>
          </div>
        </div>
        <div className="-mx-3 sm:flex items-start ">
          <div className="px-3 sm:w-1/3">
            <div className="w-full mx-auto rounded-lg bg-white border border-primary-color p-5 text-gray-800 font-light mb-6">
